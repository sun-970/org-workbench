...
const APP_RESOURCE_REQUIRED_ENTRIES = [
  ...
  "node_modules/@roleweave/shared/dist/model-selection.js",
  "apps/server/dist/src/model-selection.js",
  "apps/server/dist/src/agent-binding.js",
